"""Tests for the Kimodo -> lerobot Unitree G1 hardware bridge.

The bridge is a pure name-rename (both sides expose the same 29 joints in the
same canonical order). These tests pin the frozen map + failure surfaces
without requiring a real robot or the unitree_sdk2py runtime.
"""

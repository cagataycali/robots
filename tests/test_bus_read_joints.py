"""A broken camera must not be able to hide an arm's joints (Q44).

MEASURED 2026-08-20 on the live fleet: so101-arm-1 had published ZERO joints for eleven
hours while /api/fleet showed it connected and non-stale. The only trace was one line five

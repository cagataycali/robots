...
class TestTrainingPipeline:
    ...
    def test_concrete_trainers_exist(self):
        from strands_robots.training import (
            Gr00tTrainer, LerobotTrainer,
            DreamgenIdmTrainer, DreamgenVlaTrainer,
        )
...
class TestProcessor:
    ...
    def test_import_processor(self):
        from strands_robots.processor import ProcessorBridge, ProcessedPolicy
...
class TestVisualizer:
    ...
    def test_import_visualizer(self):
        from strands_robots.visualizer import RecordingVisualizer, RecordingStats
...
class TestIsaacBackend:
    ...
    def test_isaac_modules_exist(self):
        from strands_robots.isaac import isaac_sim_backend, isaac_gym_env

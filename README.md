...
- **Any policy.** VLA models (NVIDIA Cosmos 3, LeRobot ACT/Pi0/SmolVLA/Diffusion),
...
packages one of the local trainer paths (the `cosmos3` provider
...
└── tools/                 # lerobot_*, pose, serial, robot_mesh
```

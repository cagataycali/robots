...
Every environment variable the package reads, the asset cache layout and the
CA pin rotation runbook live in [docs/reference/configuration.md](docs/reference/configuration.md).

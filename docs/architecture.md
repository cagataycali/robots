...
| `strands_robots/tools/` | 25 `@tool`-decorated helpers. | `lerobot_calibrate`, `serial_tool`, etc. |
...
| `[all]` | 20 of the 33 extras - not a union; see [installation](getting-started/installation.md) for the 12 it leaves opt-in | CI / exploration |

...
off" reads as "safe to move by hand". Every action that writes to the servos
stops for operator approval as before - `execute` and `start`, and the three
direct ones below; see

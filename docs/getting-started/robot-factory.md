...
open_duck_mini, reachy_mini, so100, so101, trossen_wxai, unitree_g1, ur10e, ur5e, vx300s,
wx250s. Either use driver='lerobot' (today's default, which builds it through lerobot) or

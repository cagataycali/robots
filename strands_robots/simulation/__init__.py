...
# Auto-configure MuJoCo GL backend for headless environments.
# Must run before any `import mujoco` — safe to call multiple times.
try:
    from strands_robots.simulation.mujoco.backend import _configure_gl_backend as _cfg

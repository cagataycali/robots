...
if TYPE_CHECKING:
    from strands_robots.simulation.policy_runner import Policy
...
class NewtonSimulation(SimEngine):
    ...
    # ------------------------------------------------------------------
    # SimEngine — Robot query (required)
    # ------------------------------------------------------------------

    def list_robots(self) -> list[str]:
        """Return ordered list of robot names currently in the world."""
        raise NotImplementedError("list_robots() — coming in PR 2 (world lifecycle)")

    def robot_joint_names(self, robot_name: str) -> list[str]:
        """Return ordered joint names for a robot."""
        raise NotImplementedError("robot_joint_names() — coming in PR 2 (world lifecycle)")

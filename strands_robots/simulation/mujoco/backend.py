...
# GL backend selection lives in the stdlib-only leaf module
# strands_robots._mujoco_gl so that strands_robots/__init__ can run it without
# importing the simulation package. Re-exported here for the doctor, the tests
# and the rendering helpers below.
from strands_robots._mujoco_gl import (  # noqa: E402,F401
    _GLVND_EGL_VENDOR_DIRS,
    _MUJOCO_GL_ANY_PLATFORM,
    _MUJOCO_GL_DISABLE,
    _MUJOCO_GL_OFFSCREEN,
    _MUJOCO_GL_OFFSCREEN_LIBRARIES,
    _MUJOCO_GL_PLATFORM_ONLY,
    _NVIDIA_EGL_ICD_JSON,
    _NVIDIA_EGL_LIB_DIRS,

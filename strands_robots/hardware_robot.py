...
class Robot(TeleopMixin, AgentTool):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            data_config: Data configuration naming the provider's embodiment schema
    ...
    async def _get_policy(
        ...
        **policy_kwargs: Any,
        ...
        # field is the source of truth - cosmos3/lerobot_async dial a server
    ...
    def _policy_port_error(policy_port: Any, method: str, policy_provider: str | None = None) -> dict[str, Any] | None:
        ...
        docstring already names "the policy providers that dial one (``cosmos3``,
            ...
            "inputSchema": {
                "json": {
                    ...
                    "properties": {
                        ...
                        "policy_provider": {
                            "type": "string",
                            "description": "Policy provider that dials a service port (cosmos3, lerobot_async, remote, ...)",
                            "default": "cosmos3",
                        },
                        "duration": {
                            "type": "number",
    ...
    async def stream(
        ...
        try:
            ...
            if action == "execute":
                ...
                policy_provider = input_data.get("policy_provider", "cosmos3")

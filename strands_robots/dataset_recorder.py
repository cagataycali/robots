...
class DatasetRecorder:
    ...
    def add_frame(
        ...
        # BUG-06 FIX: Use feature schema ordering (joint_names) instead of sorted()
        # to match the dataset schema declared in _build_features().
        if state_keys:
            state_vals = []
            state_names = []
            try:
        ...
        # BUG-06 FIX: Use feature schema ordering for actions too.
        if action:
            action_vals = []
            action_names = []
            try:

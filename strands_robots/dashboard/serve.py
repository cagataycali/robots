...
class DashboardHandler(SimpleHTTPRequestHandler):
    ...
    def _serve_asset(self, path):
        ...
        try:
            ...
            ct = {".stl": "model/stl", ".xml": "application/xml", ".json": "application/json",
                  ".png": "image/png", ".jpg": "image/jpeg", ".obj": "model/obj"}.get(ext, "application/octet-stream")
            self.send_response(200)
    ...
    def _api_camera_capture(self, params):
        ...
        self._json_response({"image": f"data:image/jpeg;base64,{b64}", "width": frame.shape[1], "height": frame.shape[0]})
    ...
    def _api_robot_scene(self, params):
        ...
        try:
            ...
            for i in range(model.nbody):
                ...
                for g in range(model.ngeom):
                    if model.geom_bodyid[g] == i:
                        ...
                        geom_data = {"name": gname, "type": gtype, "size": gsize,
                                     "pos": gpos, "quat": gquat, "rgba": rgba}
                ...
                bodies.append({"id": i, "name": name, "parent": parent,
                               "pos": pos, "quat": quat, "geoms": geoms})
            ...
            for j in range(model.njnt):
                ...
                joints.append({"id": j, "name": jname, "type": jtype, "body_id": body_id,
                               "axis": axis, "range": jrange})
...
async def _handle_ws_msg(msg, ws):
    ...
    if action == "tell":
        ...
        try:
            ...
            if mesh:
                result = mesh.send(target, {"action":"execute","instruction":instruction,
                    "policy_provider":msg.get("policy_provider","mock"),"duration":msg.get("duration",30.0)})

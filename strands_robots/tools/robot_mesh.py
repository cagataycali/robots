    ...
    try:
        ...
        if action == "peers":
            ...
            if not target or not instruction:
                return {
                    "status": "error",
                    "content": [{"text": "target and instruction required"}],
                }
            mesh = _any_mesh()
            if not mesh:
                return {
                    "status": "error",
                    "content": [{"text": "No local robots on mesh"}],
                }
            cmd = {
                "action": "execute",
            ...
            return {
                "status": "success",
                "content": [{"text": f"🛑 {target}: {json.dumps(r, default=str)}"}],
            }
            ...
            return {
                "status": "success",
                "content": [{"text": f"🚨 E-STOP → {len(rs)} responses"}],
            }
            ...
            if not target:
                return {
                    "status": "error",
                    "content": [{"text": "target (peer_id) required"}],
                }
            mesh = _any_mesh()
            if not mesh:
                return {
            ...
            if not mesh or not hasattr(mesh, "inbox"):
                return {
                    "status": "success",
                    "content": [{"text": "No subscriptions active"}],
                }

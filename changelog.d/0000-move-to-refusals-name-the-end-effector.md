...
body, else the chain's leaf), and on a humanoid or quadruped that rung lands on
a wrist link or a leg. The success text named that frame; the three refusals
